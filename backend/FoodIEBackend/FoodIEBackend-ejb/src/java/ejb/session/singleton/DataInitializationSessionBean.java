...
public class DataInitializationSessionBean {
    ...
    List<ActorUserEntity> lsFarmer;

    public DataInitializationSessionBean() {
        lsFarmer = new ArrayList<>();
    }
    ...
    private void initializeLoggedInUserTransaction() {
        ...
        LoggedInUserRecordEntity loggedInUserRecordEntity = new LoggedInUserRecordEntity(token, lsFarmer.get(0));
        loggedInUserRecordEntity = loggedInUserRecordEntityControllerLocal.createNewLoggedInUserRecord(loggedInUserRecordEntity);
        System.out.println("time: " + loggedInUserRecordEntity.getTimestampDateTime() + "    email: " + loggedInUserRecordEntity.getActorUser().getEmail());
    }
}
